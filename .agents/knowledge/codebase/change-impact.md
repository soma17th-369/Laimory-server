...
| AI 서버간 계약(dispatch/입력/결과/콜백) | source staging·영수증 entity/schema, dispatcher(+fixture), 단계별 토큰, fake dispatcher, cleanup, glossary | focused contract tests + `TimelineAiTaskFlowIntegrationTest` |
