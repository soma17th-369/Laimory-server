...
| AI 서버간 계약(dispatch/입력/결과/콜백) | source staging, dispatcher(+fixture), 단일 task token, Redis stage/CAS, fake dispatcher, glossary | focused contract tests + `TimelineAiTaskFlowIntegrationTest` |
