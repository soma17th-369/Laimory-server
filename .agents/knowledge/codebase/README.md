...
| [Deployment](operations/deployment.md) | 배포·preflight·복구를 바꿀 때 | deploy workflow, Dockerfile, live host | rollout·health·rollback·운영 절차가 바뀔 때 | workflow/live state | build/image/workflow validation |
