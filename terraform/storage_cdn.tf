...
locals {
  monitoring_bootstrap_assets = {
    ...
    "grafana/alert-rule-files.txt"                                    = "grafana/alert-rule-files.txt"
    ...
    "grafana/provisioning/alerting/application-rules.yml"              = "grafana/provisioning/alerting/application-rules.yml"
    "grafana/provisioning/alerting/availability-rules.yml"             = "grafana/provisioning/alerting/availability-rules.yml"
    "grafana/provisioning/alerting/extended-infrastructure-rules.yml"  = "grafana/provisioning/alerting/extended-infrastructure-rules.yml"
    "grafana/provisioning/alerting/infrastructure-rules.yml"           = "grafana/provisioning/alerting/infrastructure-rules.yml"
    "grafana/provisioning/alerting/lifecycle-rules.yml"                = "grafana/provisioning/alerting/lifecycle-rules.yml"
    "grafana/provisioning/alerting/log-pipeline-rules.yml"             = "grafana/provisioning/alerting/log-pipeline-rules.yml"
    "grafana/provisioning/alerting/prometheus-rules.yml"               = "grafana/provisioning/alerting/prometheus-rules.yml"
    "grafana/provisioning/alerting/tls-rules.yml"                      = "grafana/provisioning/alerting/tls-rules.yml"
    ...
    "scripts/deploy-alert-rules.sh"                                    = "scripts/deploy-alert-rules.sh"
    "scripts/publish-alert-rules.sh"                                   = "scripts/publish-alert-rules.sh"
    "scripts/validate-alert-rules.sh"                                  = "scripts/validate-alert-rules.sh"
