...
bastion_ssh_allowed_cidrs = ["121.162.157.81/32", "14.33.157.163/32", "59.11.224.64/32", "58.224.80.134/32"]
...
# dev Grafana HTTPS reverse proxy 접근 허용 CIDR (Kibana와 달리 deny all을 포함해 제한)
grafana_allowed_cidrs = ["121.162.157.81/32", "14.33.157.163/32", "59.11.224.64/32", "58.224.80.134/32"]
