...
public class NotificationConsentEvent extends BaseEntity {
    ...
    private NotificationConsentEvent(UUID subjectId, NotificationConsentType consentType,
    ...
    public static NotificationConsentEvent of(UUID subjectId, NotificationConsentType consentType,
                                              NotificationConsentAction action, Long termDocumentId,
                                              LocalDateTime occurredAt, String senderName,
                                              NotificationConsentProcessingResult processingResult,
                                              NotificationConsentSource source) {
        return new NotificationConsentEvent(subjectId, consentType, action, termDocumentId,
