...
public class AppInitializerService {
     ...
     */
    public InitializerResponse getInitialState(String applicationVersion, Long userId, UUID subjectId) {
        // applicationVersion: 버전별 처리 분기 지점(현재 단일 버전이라 분기 없음).
        boolean onboardingCompleted = subjectPreferenceService.findOnboardingCompleted(subjectId);
