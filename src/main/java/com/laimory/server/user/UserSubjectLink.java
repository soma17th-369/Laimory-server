 ...
 * PK는 HMAC-SHA-256 lookup key 32바이트이고, subject는 CSPRNG UUIDv4의 canonical 16바이트다.
 *
...
public class UserSubjectLink {
    ...
    private UserSubjectLink(byte[] userLookupKey, byte[] subjectId, short lookupKeyVersion) {
        this.userLookupKey = userLookupKey;
        this.subjectId = subjectId;
        this.lookupKeyVersion = lookupKeyVersion;
    }

    public static UserSubjectLink of(byte[] userLookupKey, byte[] subjectId, short lookupKeyVersion) {
