...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ApiResponse<Void> body(ErrorCode code, Object[] args, HttpServletRequest request) {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        return ResponseEntity.status(statusCode).headers(headers) // Allow 등 표준 헤더 보존
                .body(body(ErrorCode.fromStatus(statusCode), null, servletRequest));
    }
    ...
    ResponseEntity<ApiResponse<Void>> onBusiness(BusinessException e, HttpServletRequest request) {
        ...
        return ResponseEntity.status(code.status()).body(body(code, e.getArgs(), request));
    }
    ...
    ResponseEntity<ApiResponse<Void>> onResponseStatus(ResponseStatusException e, HttpServletRequest request) {
        ...
        return ResponseEntity.status(e.getStatusCode())
                .body(body(ErrorCode.fromStatus(e.getStatusCode()), null, request));
    }
