...
CREATE TABLE user_subject_links (
...
CREATE TABLE timeline_photo_delete_jobs (
...
CREATE TABLE timeline_draft_source_items (
...
CREATE TABLE daily_notification_preferences (
    subject_id VARCHAR(36) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
