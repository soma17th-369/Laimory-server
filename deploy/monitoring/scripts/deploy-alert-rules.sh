...
GRAFANA_RELOAD_URL=${GRAFANA_RELOAD_URL:-http://localhost:3000/api/admin/provisioning/alerting/reload}
GRAFANA_PROVISIONING_RULE_URL=${GRAFANA_PROVISIONING_RULE_URL:-http://localhost:3000/api/v1/provisioning/alert-rules}
